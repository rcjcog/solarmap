...
export default async function decorate(block) {
  ...
  const navTopMeta = getMetadata('navtop');
  const navTopPath = navTopMeta ? new URL(navTopMeta, window.location).pathname : '/navtop';
...
if (navTopFragment) {
  ...
  const classes = ['navtop','brand', 'sections', 'tools'];
  classes.forEach((c, i) => {
